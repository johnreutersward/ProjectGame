...
namespace ProjectGame
{
    public static class Conversation
    {
        ...
        public static int currentSpeakerIndex = 0;
        ...
        public static void Initialize(SpriteFont font, Texture2D background, Rectangle initialRectangle, Texture2D bImage, int bWidth, Color bColor, Texture2D sIcon, ContentManager content)
        {
            spriteFont = font;
        ...
        public static void LoadConversation(int id)
        {
            ...
            ConversationSpeakers = Content.Load<List<Speaker>>(@"WindowsText\" + id);
        }
